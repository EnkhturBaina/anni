...
!(function (t, e) {
    ...
    return (
      ...
      function (t, e, r) {
        ...
        if (!p) {
          ...
          for (p = v[d] = [], i = y ? Math.min(f, d) * T - 0.5 : m % f, n = f === j ? 0 : y ? (d * w) / f - 0.5 : (m / f) | 0, l = j, u = h = 0; u < d; u++) (a = (u % f) - i), (s = n - ((u / f) | 0)), (p[u] = o = b ? Math.abs("y" === b ? s : a) : G(a * a + s * s)), h < o && (h = o), o < l && (l = o);
  ...
  function rb(t, e, r) {
    ...
    return e && !d && ((i = p[0] / kt), (n = p[1] / kt), (a = p[2] / kt), (u = ((h = Math.max(i, n, a)) + (l = Math.min(i, n, a))) / 2), h === l ? (s = o = 0) : ((f = h - l), (o = 0.5 < u ? f / (2 - h - l) : f / (h + l)), (s = h === i ? (n - a) / f + (n < a ? 6 : 0) : h === n ? (a - i) / f + 2 : (i - n) / f + 4), (s *= 60)), (p[0] = ~~(s + 0.5)), (p[1] = ~~(100 * o + 0.5)), (p[2] = ~~(100 * u + 0.5))), r && p.length < 4 && (p[3] = 1), p;
  }
  function sb(t) {
    var r = [],
      i = [],
  ...
  var R,
    ...
    kt = 255,
    Ct = { aqua: [0, kt, kt], lime: [0, kt, 0], silver: [192, 192, 192], black: [0, 0, 0], maroon: [128, 0, 0], teal: [0, 128, 128], blue: [0, 0, kt], navy: [0, 0, 128], white: [kt, kt, kt], olive: [128, 128, 0], yellow: [kt, kt, 0], orange: [kt, 165, 0], gray: [128, 128, 128], purple: [128, 0, 128], green: [0, 128, 0], red: [kt, 0, 0], pink: [kt, 192, 203], cyan: [0, kt, kt], transparent: [kt, kt, kt, 0] },
    Pt = (function () {
      var t,
          ...
          ? (f || e in t || N(e, i),
            function _addComplexStringPropTween(t, e, r, i, n, a, s) {
              var o,
                ...
                m = 0,
                g = 0;
              for (_.b = r, _.e = i, r += "", (p = ~(i += "").indexOf("random(")) && (i = gb(i)), a && (a((c = [r, i]), t, e), (r = c[0]), (i = c[1])), u = r.match(it) || []; (o = it.exec(i)); ) (l = o[0]), (f = i.substring(m, o.index)), h ? (h = (h + 1) % 5) : "rgba(" === f.substr(-5) && (h = 1), l !== u[g++] && ((d = parseFloat(u[g - 1]) || 0), (_._pt = { _next: _._pt, p: f || 1 === g ? f : ",", s: d, c: "=" === l.charAt(1) ? parseFloat(l.substr(2)) * ("-" === l.charAt(0) ? -1 : 1) : parseFloat(l) - d, m: h && h < 4 ? Math.round : 0 }), (m = it.lastIndex));
  ...
  function Bd(t, e, r, i) {
    ...
    return i === h || !u || Ue[i] || Ue[h]
      ...
      : ("px" === h || c || (u = Bd(t, e, r, "px")),
        (o = t.getCTM && xd(t)),
        (!m && "%" !== h) || (!Fe[e] && !~e.indexOf("adius")) ? ((l[f ? "width" : "height"] = 100 + (c ? h : i)), (a = ~e.indexOf("adius") || ("em" === i && t.appendChild && !d) ? t : t.parentNode), o && (a = (t.ownerSVGElement || {}).parentNode), (a && a !== he && a.appendChild) || (a = he.body), (s = a._gsap) && m && s.width && f && s.time === St.time ? ca((u / s.width) * 100) : ((!m && "%" !== h) || (l.position = qd(t, "position")), a === t && (l.position = "static"), a.appendChild(de), (n = de[p]), a.removeChild(de), (l.position = "absolute"), f && m && (((s = _(a)).time = St.time), (s.width = a[p])), ca(c ? (n * u) / 100 : n && u ? (100 / n) * u : 0))) : ((n = o ? t.getBBox()[f ? "width" : "height"] : t[p]), ca(m ? (u / n) * 100 : (u / 100) * n)));
  }
  function Cd(t, e, r, i) {
    var n;
  ...
  function Dd(t, e, r, i) {
    ...
    if (((v.b = r), (v.e = i), (r += ""), "auto" === (i += "") && ((t.style[e] = i), (i = qd(t, e) || i), (t.style[e] = r)), wb((s = [r, i])), (i = s[1]), (u = (r = s[0]).match(rt) || []), (i.match(rt) || []).length)) {
      for (; (o = rt.exec(i)); ) (d = o[0]), (c = i.substring(y, o.index)), l ? (l = (l + 1) % 5) : ("rgba(" !== c.substr(-5) && "hsla(" !== c.substr(-5)) || (l = 1), d !== (f = u[b++] || "") && ((h = parseFloat(f) || 0), (m = f.substr((h + "").length)), (g = "=" === d.charAt(1) ? +(d.charAt(0) + "1") : 0) && (d = d.substr(2)), (p = parseFloat(d)), (_ = d.substr((p + "").length)), (y = rt.lastIndex - _.length), _ || ((_ = _ || Y.units[e] || m), y === i.length && ((i += _), (v.e += _))), m !== _ && (h = Bd(t, e, f, _) || 0), (v._pt = { _next: v._pt, p: c || 1 === b ? c : ",", s: h, c: g ? g * p : p - h, m: (l && l < 4) || "zIndex" === e ? Math.round : 0 }));
  ...
  var ue,
    ...
    ir = function _renderSVGTransforms(t, e) {
      ...
      (d = parseFloat(d)),
        ...
        d || p ? ((d *= Be), (p *= Be), (r = Math.cos(d) * _), (i = Math.sin(d) * _), (n = Math.sin(d - p) * -m), (a = Math.cos(d - p) * m), p && ((c *= Be), (s = Math.tan(p - c)), (n *= s = Math.sqrt(1 + s * s)), (a *= s), c && ((s = Math.tan(c)), (r *= s = Math.sqrt(1 + s * s)), (i *= s))), (r = ca(r)), (i = ca(i)), (n = ca(n)), (a = ca(a))) : ((r = _), (a = m), (i = n = 0)),
